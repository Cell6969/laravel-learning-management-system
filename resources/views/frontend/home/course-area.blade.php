@php
    ...
    ->limit(6)
    ->get();
    $categories = \App\Models\Category::query()->orderBy('category_name', 'asc')->get();
@endphp
        ...
        <ul class="nav nav-tabs generic-tab justify-content-center pb-4" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link" id="business-tab" data-toggle="tab" href="#business" role="tab"
                   aria-controls="business" aria-selected="false">All</a>
            </li>
            ...
            <div class="tab-content" id="myTabContent">
                ...
                @foreach($categories as $category)
                    <div class="tab-pane fade" id="business{{$category->id}}" role="tabpanel"
                        ...
                        <div class="row">
                            @php
                                $courseByCategory = \App\Models\Course::query()
                                ->where('category_id', $category->id)
                                ->where('status', 1)
                                ->orderBy('id','desc')->get();
                            @endphp

                            @forelse( $courseByCategory as $course )
                                <div class="col-lg-4 responsive-column-half">
...
@php
    $courseData = \App\Models\Course::query()->get();
@endphp
{{--Tool tip templates--}}
        ...
        <div id="tooltip_content_1{{$course->id}}">
            <div class="card card-item">
                <div class="card-body">
                    ...
                    @php
                        $goals = \App\Models\CourseGoal::query()
