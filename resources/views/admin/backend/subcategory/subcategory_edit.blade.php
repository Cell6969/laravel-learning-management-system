    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{route('subcategory.all')}}"><i class="bx bx-home-alt"></i></a>
                        </li>
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form class="row g-3" id="myForm" action="{{route('subcategory.update', ['id' => $subcategory->id])}}" method="post">
                    @csrf
