            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#"
                   role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img
                        src="{{(!empty($user->photo)) ? url('upload/instructor_images/'.$user->photo): url('upload/no_image.png')}}"
                        alt="Admin"
                        class="rounded-circle p-1" width="60">
                    <div class="user-info">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('instructor.change_password')}}"><i
