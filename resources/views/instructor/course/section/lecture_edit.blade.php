...
@section('instructor')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('instructor.course.section.add',['id' => $lecture->course_id]) }}"
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form id="myForm"
                      action="{{route('instructor.course.lecture.update', ["course_id" => $lecture->course_id, "section_id" => $lecture->section_id, "lecture_id" => $lecture->id])}}"
